...
(setq org-capture-templates
      '(("t" "Todo" entry (file+headline "~/stuff/organizer/inbox.org" "Tasks")
         "* TODO %?\nDEADLINE: %t")
        ("n" "Meeting notes" entry (file+headline "~/stuff/organizer/inbox.org" "Meetings")
         (file "~/stuff/organizer/templates/meeting_notes.org"))))
#+END_SRC
